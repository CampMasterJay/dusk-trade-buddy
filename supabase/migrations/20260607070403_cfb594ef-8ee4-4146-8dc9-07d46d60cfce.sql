...
ALTER TABLE public.trades
  ADD COLUMN IF NOT EXISTS stop_distance_points numeric,
  ADD COLUMN IF NOT EXISTS max_adverse_excursion_points numeric,
  ADD COLUMN IF NOT EXISTS max_favorable_excursion_points numeric,
  ADD COLUMN IF NOT EXISTS stop_was_hit_before_target boolean,
  ADD COLUMN IF NOT EXISTS price_came_within_ticks_of_stop numeric,
  ADD COLUMN IF NOT EXISTS stop_and_reversed boolean,
  ADD COLUMN IF NOT EXISTS stop_and_reverse_points numeric;
