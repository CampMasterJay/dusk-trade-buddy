...
import { WALKTHROUGHS } from "@/lib/walkthroughs/catalog";
  ...
  return (
    <section className="rounded-xl border border-border bg-card p-6 mb-4">
      <div className="flex items-center gap-2 mb-1">
        ...
        <h2 className="text-lg font-semibold font-heading">Walkthroughs</h2>
      </div>
      <p className="text-xs text-muted-foreground mb-4">
        Guided tours of EdgeTrader — replay anytime.
      </p>
