            ...
            messages: [
              {
                role: "system",
                content:
                  "You are a trading chart analyst. Analyze the chart screenshot and respond ONLY with compact JSON matching this shape: {\"instrument\":string|null,\"timeframe\":string|null,\"trend\":\"bullish\"|\"bearish\"|\"sideways\",\"structure\":string,\"keyLevels\":{\"support\":string[],\"resistance\":string[]},\"patterns\":string[],\"indicators\":string[],\"bias\":string,\"setupIdea\":{\"direction\":\"long\"|\"short\"|\"none\",\"entry\":string,\"stop\":string,\"target\":string,\"rr\":string},\"risks\":string[],\"summary\":string}. Keep arrays short (max 4). No markdown, no commentary outside JSON.",
              },
              {
                role: "user",
                content: [
